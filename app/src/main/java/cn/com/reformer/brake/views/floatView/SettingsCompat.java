...
public class SettingsCompat {
    ...
    private static boolean manageDrawOverlaysForEmui(Context context) {
        ...
        intent.setClassName(HUAWEI_PACKAGE, "com.huawei.permissionmanager.ui.BleMainActivity");
        if (startSafely(context, intent)) {
            return true;
        }
        return false;
    ...
    private static boolean manageDrawOverlaysForVivo(Context context) {
        ...
        intent.setClassName("com.iqoo.secure", "com.iqoo.secure.BleMainActivity");
    ...
    private static boolean manageDrawOverlaysForSmartisan(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            //        intent.setClassName("com.smartisanos.security", "com.smartisanos.security.BleMainActivity");
            return startSafely(context, intent);
        }
    }
}